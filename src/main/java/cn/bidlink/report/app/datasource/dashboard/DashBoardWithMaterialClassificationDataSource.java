...
/**
 * @ClassName DashBoardWithMaterialClassificationDataSource
 * @Author congyaozhu
 * @Description 物料分类金额占比
 * @Date 2019/9/19 11:54
 * @Version 1.0
 **/
public class DashBoardWithMaterialClassificationDataSource extends AbstractBaseTableData {
    ...
    protected String[] getColumn() {
        return new String[]{"catalog_name", "catalog", "price" , "percentage" };
    }
    ...
    protected List getQueryData(DataServiceFactory dataServiceFactory, Map<String, String> param) {
        ...
        if(StringUtils.isNotEmpty(companyId) && StringUtils.isNotEmpty(startDate)
            ...
            ServiceResult<List<Map>> listServiceResult = supplierPurchaseStatisticsService.catalogPath(dto);
