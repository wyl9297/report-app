 ...
 * @version Ver 1.0
 * @description:查询采购成交采购品统计  查询采购成交采购品统计钻取项目所对应供应商详情数据集
 * @Date 2019/9/10
 *
 */
public class PurchaseDealStatisticalDetailDataSource extends AbstractBaseTableData {
    @Override
    ...
    protected String[] getColumn() {
        return new String[]{"id", "projectId", "companyId", "directoryId", "projectName", "supplierName", "dealPrice", "dealAmount", "dealTotalPrice", "publishBidResultTime", "createSource", "createUserName", "departmentName"};
    }
    ...
    protected List getQueryData(DataServiceFactory dataServiceFactory, Map<String, String> param) {
        ...
        ServiceResult<List<PurchaseNewProjectWideTable>> findPurchaseDealStatisticalDetail = purchaseDealStatisticalService.findPurchaseDealStatisticalDetail(purchaseNewProjectWideTable);
        List<PurchaseNewProjectWideTable> result = findPurchaseDealStatisticalDetail.getResult();
