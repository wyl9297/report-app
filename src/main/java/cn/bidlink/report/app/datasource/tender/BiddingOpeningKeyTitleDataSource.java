 ...
 * @version Ver 1.0
 * @description:招标项目->开标一览表结果动态数据集表头
 * @Date 2019/5/31
 *
 */
public class BiddingOpeningKeyTitleDataSource extends AbstractBaseTableData {
    ...
    protected List getQueryData(DataServiceFactory dataServiceFactory, Map<String, String> param) {
        ...
        List<BiddingResultDynamicChangeVo> subProjectId = tenderProxyService.getDecideBidViewKeyTitle(Long.valueOf(param.get("subProjectId")));
        return subProjectId;
    }
