 ...
 * @Author congyaozhu
 * @Description //供应商采购中标列表 数据集
 * @Date 2019/9/10 11:45
 * @Version 1.0
 **/
public class SupplierWinItemDataSource extends AbstractBaseTableData {
    @Override
    ...
    protected String[] getColumn() {
        return new String[]{"id", "projectCode", "projectName", "winBidTime", "directoryName", "spec" , "planAmount", "dealPrice", "dealAmount"
                , "dealTotalPrice", "projectSource", "supplierName"};
    }
    ...
    protected List getQueryData(DataServiceFactory dataServiceFactory, Map<String, String> param) {
        ...
        ServiceResult<List<ProjectWideTable>> listServiceResult = supplierPurchaseStatisticsService.selSupplierWinBySupplierId(supplierId, companyId);
