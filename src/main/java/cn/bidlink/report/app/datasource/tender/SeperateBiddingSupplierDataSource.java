 ...
 * @Version 1.0
 **/
public class SeperateBiddingSupplierDataSource extends AbstractBaseTableData {
    ...
    protected String[] getColumn() {
        return new String[]{ "differenceAmount" , "quoteTotalPrice" , "differenceRatio" , "quoteUnitPrice" , "itemId" , "itemCode" , "supplierId"};
    }
    ...
    protected List getQueryData(DataServiceFactory dataServiceFactory, Map<String, String> param) {
        ...
        if(!StringUtils.isEmpty(quoteTurn) && isNumber){
            ...
            List<Map<String, Object>> multipleSupplierBidItemList1 = tenderProxyService.getMultipleBidItemSupplierDataSource(subProjectId, supplierIds , Integer.valueOf(quoteTurn));
            return multipleSupplierBidItemList1;
        }else{
            //展示所有供应商报价信息
            List<Map<String, Object>> reportDataList = tenderProxyService.getSeperateBiddingSupplierDataSource(subProjectId, supplierIds);
