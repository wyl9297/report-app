...
public class PurchaseSupplierPurDetailDataSource extends AbstractBaseTableData {
    ...
    protected String[] getColumn() {
        return new String[]{"id" ,"projectId" ,"directoryId" ,"companyId" ,"name", "code", "spec", "techParameters", "purchaseAmount", "unitName", "marketPrice", "appliedPersonAndPhone", "appliedEnterprise", "useDept", "purpose", "needTime", "comment", "currency" , "planPrice"};
    }
