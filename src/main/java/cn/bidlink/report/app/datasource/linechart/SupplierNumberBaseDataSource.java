 ...
 *
 */
public class SupplierNumberBaseDataSource extends AbstractBaseTableData {
    ...
    protected String[] getColumn() {
        return new String[]{"creatTime", "timeYears", "timeQuarter", "timeMonth", "timeDay", "count", "timeMonthDay"};
    }
    ...
    protected List getQueryData(DataServiceFactory dataServiceFactory, Map<String, String> param) {
        ...
        ResponseResult createSupplierCount = lineDiagramCloudService.getCreateSupplierCount(purchaseNewProjectWideTable.getStartCreateTime(), purchaseNewProjectWideTable.getEndCreateTime());
        List<Map<String, Object>> data = (List<Map<String, Object>>) createSupplierCount.getData();
        return data;
