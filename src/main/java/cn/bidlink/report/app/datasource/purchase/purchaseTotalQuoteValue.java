 ...
 * @Version 1.0
 **/
public class purchaseTotalQuoteValue extends AbstractBaseTableData {
    ...
    protected String[] getColumn() {
        return new String[]{"key","value","supplierId"};
    }
    ...
    protected List getQueryData(DataServiceFactory dataServiceFactory, Map<String, String> param) {
        ...
        //查询数据并返回
        List<Map> list = purchaseProxyService.totalQuoteValue(Long.valueOf(projectId));
        return list;
    }
