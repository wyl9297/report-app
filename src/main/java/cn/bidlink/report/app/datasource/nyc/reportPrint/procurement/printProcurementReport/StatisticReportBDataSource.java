...
public class StatisticReportBDataSource extends AbstractColumnPositionTableData {
    private static Logger log = LoggerFactory.getLogger(StatisticReportBDataSource.class);
