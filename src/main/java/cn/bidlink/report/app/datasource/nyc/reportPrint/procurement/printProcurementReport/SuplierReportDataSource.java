...
public class SuplierReportDataSource extends AbstractColumnPositionTableData {
    private static Logger log = LoggerFactory.getLogger(SuplierReportDataSource.class);
